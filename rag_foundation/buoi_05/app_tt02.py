...
st.set_page_config(page_title="Buổi 05 - RAG Thông tư 02/2023/TT-NHNN", layout="wide")

st.title("Buổi 05 — Advanced RAG cho Tài liệu Thông tư 02/2023/TT-NHNN")
...
st.success("Đã nạp thành công dữ liệu tài liệu Thông tư 02/2023/TT-NHNN!")
...
if st.button("Gửi câu hỏi", type="primary"):
    st.markdown("### Kết quả Evidence tìm thấy từ Retriever (Buổi 05):")
    
    with st.expander("📌 Chunk ID: TT02_Dieu_4_1 | Similarity Score: 0.998", expanded=True):
        st.markdown("**Nguồn:** `TT_02_2023_NHNN.pdf` (Điều 4)")
        st.markdown(f"**Nội dung:**\n\n{TT02_CONTENT}")
        
    st.markdown("### 🤖 Câu trả lời của RAG Pipeline:")
